...
def parse_dose_data(dose_data, dose_filter=None):
    dose_data["Vacc_perc_population"] = (
        dose_data["Antal vaccinerade"] / Swedish_population
    ) * 100
    if dose_filter:
    ...
    for ind in range(1, 5):
        week_data = dose_data[
            dose_data["date"] == dose_data["date"].unique()[-abs(ind)]
        ]
        last_three_weeks_data.append(float(week_data["Procent vaccinerade"].round(2)))
        pop_last_three_weeks_data.append(
            float(week_data["Vacc_perc_population"].round(2))
        )
    return (
        last_three_weeks_data[0],
        float_str(last_three_weeks_data[0] - last_three_weeks_data[1]),
        float_str(
            (last_three_weeks_data[0] - last_three_weeks_data[1])
        ...
        float_str(
            (pop_last_three_weeks_data[0] - pop_last_three_weeks_data[1])
...
(
    ...
    onedose_ratechange,
    one_dose_pop,
    rate_onedose_pop_lastwk,
    onedose_ratechange_pop,
) = parse_dose_data(first_two_timeseries, "Minst 1 dos")
...
(
    ...
    twodose_ratechange,
    least_two_dose_pop,
    rate_leasttwodose_pop_lastwk,
    twodose_ratechange_pop,
) = parse_dose_data(first_two_timeseries, "Minst 2 doser")

(
    third_dose_swe,
    rate_threedose_lastwk,
    threedose_ratechange,
    third_vacc_dose_pop,
    rate_threedose_pop_lastwk,
    threedose_ratechange_pop,
) = parse_dose_data(third_timseries)

(
    fourth_dose_swe,
    rate_fourdose_lastwk,
    fourdose_ratechange,
    fourth_vacc_dose_pop,
    rate_fourdose_pop_lastwk,
    fourdose_ratechange_pop,
) = parse_dose_data(fourth_timseries)

(
    fifth_dose_swe,
    rate_fivedose_lastwk,
    fivedose_ratechange,
    fifth_vacc_dose_pop,
    rate_fivedose_pop_lastwk,
    fivedose_ratechange_pop,
) = parse_dose_data(fifth_timseries)
...
data_dictionary = {
    ...
    "eligible_five_doses": fifth_dose_swe,
    ...
    "eligible_five_doses_lastweek": rate_fivedose_lastwk,
    ...
    "eligible_five_doses_rate_change": fivedose_ratechange,
    ...
    "population_five_doses": fifth_vacc_dose_pop,
    ...
    "population_five_doses_lastweek": rate_fivedose_pop_lastwk,
    ...
    "population_five_doses_rate_change": fivedose_ratechange_pop,
}
...
if __name__ == "__main__":
    ...
    with open(
        os.path.join(args.output_dir, "vaccine_text_inserts.json"), "w"
    ) as outfile:
