...
ww_inf_a = wastewater_data[(wastewater_data["target"] == "Influenza A virus")]

# Get unique list of city to loop over
all_cities = sorted(ww_inf_a.city.drop_duplicates().to_list())
...
for index, method in enumerate(["pmmov_normalised", "copies_l", "copies_day_inhabitant"], 1):
    ...
    for city in all_cities:
        ww_city_data = ww_inf_a[(ww_inf_a["city"] == city)].sort_values(by=["sampling_date"])
...
fig.update_yaxes(
    title="<b>Influenza A/PMMoV x 1000</b>",
    showgrid=True,
    gridcolor="lightgrey",
    linecolor="black",
    zeroline=True,
                ...
                [
                    ...
                    dict(
                        ...
                        args=[
                            ...
                            {
                                "yaxis.title": dict(text="<b>Influenza A copies/liter</b>")
                            }
                        ],
                    ),
                    dict(
                        ...
                        args=[
                            ...
                            {
                                "yaxis.title": dict(text="<b>Influenza A copies/inhabitant/day</b>")
                            }
                        ],
                    ),
                ]
