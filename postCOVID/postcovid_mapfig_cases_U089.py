...
for language in ["English", "Swedish"]:
    if language == "English":
        ...
        raw_number_title = "<br>Number of people that received<br>a U08.9 or Z86.1A diagnosis"
        covid_cases = "Cumulative number of<br>confirmed COVID-19 cases"
        filename = "map_postcovid_percent_of_covidcases_U089.json"
        ...
        filename = "map_postcovid_percent_of_covidcases_U089_{}.json".format(language)
